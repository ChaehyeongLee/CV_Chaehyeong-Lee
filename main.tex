...
\cvitem{}{Geofluid dynamics: upper-ocean mixing processes in the frequency-wavenumber domain.}
...
\cvitem{}{
\textbf{Lee, C.}, Giglio, D., Subramanian, A. C., Han, W., Capotondi, A., Du, D., Molod, A., \& Veronica Ruiz-Xomochuk
\textit{Effects of Satellite Sea Surface Salinity Assimilation on the Representation of Upper-Ocean Thermohaline Structure and Variability in the NASA GEOS-S2S-2 model}.
}
...
\textit{Nature Climate Change}, \textbf{15}, 308-314. 
...
\cventry{Spring 2026}
        {Teaching Assistant}
        {Data Science Laboratory, taught by Prof. Donata Giglio at CU Boulder}
        {Boulder, CO, USA}
        {}
        {}
...
\cventry{Spring 2023}
        {Teaching Assistant}
        {Climate \& Civilization, taught by Prof. Yign Noh at Yonsei Univ.}
        {Seoul, Rep. of Korea}
        {}
        {}
...
\cventry{Fall 2022}
        {Teaching Assistant}
        {Physical Oceanography, taught by Prof. Hajoon Song at Yonsei Univ.}
        {Seoul, Rep. of Korea}
        {}
        {}
...
\cventry{Sep.~2026}                 % 1: date (right)
        {\parbox[t]{0.8\textwidth}{\textit{Enhanced Upper-Ocean Horizontal Advection in a High-Resolution Climate Model Improves the Representation of High-Frequency Near-Surface Temperature Variability.}}}
        {US CLIVAR (poster)}   % 3: event name (bold, left) 
        {Boulder, CO, USA}           % 4: location (right)
        {}
...
\cventry{Feb.~2026}                 % 1: date (right)
        ...
        {}
        {}
        {\emph{\textbf{Lee, C.}, Giglio, D., Subramanian, A. C., Han, W., Capotondi, A., Du, D., \& Molod, A.}}
...
\cventry{Sep.~2026}
        ...
        {\parbox[t]{0.7\textwidth}{Broadening Earth System Research Across Scales with High-Resolution Modeling Workshop}}
        {Boulder, CO, USA}
        {}
        {}
...
\cventry{Jun.~2026}                 % 1: date (right)
        {Consortium for Advanced Data Assimilation Research and Education \& NOAA EPIC}
        {\parbox[t]{0.7\textwidth}{Data Assimilation Training and Science Workshop}}
        {Norman, OK, USA}        % 4: location (right)
        {}                           % 5: empty (grade)
...
\cventry{Jan.~2022}                 % 1: date (right)
        ...
        {\parbox[t]{0.7\textwidth}{User Training for the Glosea 6 Climate Prediction Model}}
        {Jeju, Rep. of Korea}        % 4: location (right)
        {}                           % 5: empty (grade)
        {}                           % 6: description [cite: 70, 74, 75]
...
\cventry{Jan.~2022}                 % 1: date (right)
        ...
        {\parbox[t]{0.7\textwidth}{Deep Learning Training: Fundamentals of Deep Learning}}
...
\cvitem{Programming}{Python (xarray, dask, Pangeo), Julia}
\cvitem{Modeling}{MITgcm, Oceananigans}
